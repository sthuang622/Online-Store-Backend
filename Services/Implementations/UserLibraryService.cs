...
public class UserLibraryService : IUserLibraryService
{
    ...
    public async Task<IReadOnlyList<UserLibraryDto>> GetByUserIdAsync(ulong userId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<UserLibraryDto?> GetByIdAsync(ulong id, CancellationToken cancellationToken = default)
    {
