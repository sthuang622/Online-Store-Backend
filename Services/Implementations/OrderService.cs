...
public class OrderService : IOrderService
{
    ...
    public async Task<IReadOnlyList<OrderDto>> GetByUserIdAsync(ulong userId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<OrderDto?> GetByIdAsync(ulong id, CancellationToken cancellationToken = default)
    {
